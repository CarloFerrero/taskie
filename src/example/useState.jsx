...
// 3. useState accetta un argomento che è il valore di default dello stato:
// const [count, setCount] = useState(0); 
// dove 0 è il valore di default dello stato

// 4. la funzione che modifica lo stato accetta un argomento che è il nuovo valore dello stato
// per esempio: setCount(1) imposta il nuovo valore dello stato a 1

// 5. la funzione che modifica lo stato può essere chiamata con un argomento che è una funzione 
// che accetta lo stato precedente e restituisce il nuovo stato per esempio: setState((prevState) => prevState + 1)

// 8. ogni volta che viene aggiornato lo stato il componente viene renderizzato di nuovo, per questo motivo
